...
aircraft.data.add("/sim/model/livery");
...
var Engine = {
	...
	m.carb_temp =     m.eng.initNode("carb-temp-degc",m.oat,"DOUBLE");
        ...
        m.fuel_psi =      m.eng.initNode("fuel-pressure-psi",0,"DOUBLE");
...
# Adaptation by Clément de l'Hamaide and Daniel Dubreuil for DR400-jsbsim or regent
############################################
...
# Calculate local time
  var utc_hour=getprop("/sim/time/utc/hour");
  var time_offset1=getprop("/sim/time/local-offset");
  var time_offset2=time_offset1 / 3600 ;
setprop("/sim/time/local-offset-2", time_offset2);
  var local_hour=utc_hour+time_offset2;
  setprop("/sim/time/local/hours", local_hour);
# local time end
...
var nasalInit = setlistener("/sim/signals/fdm-initialized", func{
  ...
  print("");
  print("########################################");
  print("####### I'm a "~getprop("/sim/description")~" ########");
  print("########################################");
  print("");
